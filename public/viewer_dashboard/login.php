...
<head>
    ...
    <style>
        ...
        .form-control{background:rgba(255,255,255,.10);border:1px solid rgba(255,255,255,.22);color:#ffffff;border-radius:12px;height:48px}
        .form-control::placeholder{color:rgba(255,255,255,.65)}
        .form-control:focus{background:rgba(255,255,255,.14);border-color:#dc2626;box-shadow:0 0 0 .2rem rgba(220,38,38,.25)}
        .form-control:focus::placeholder{color:#e5e7eb}
        .input-group-text{display:flex;align-items:center;justify-content:center;width:48px;min-width:48px;background:transparent;border:1px solid rgba(255,255,255,.22);border-right:0;border-top-left-radius:12px;border-bottom-left-radius:12px;color:#94a3b8}
            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-5">
                <div class="card p-4 p-lg-5">
                    ...
                    <div class="d-flex align-items-center justify-content-center gap-2 mb-2">
                        <span class="text-uppercase small" style="letter-spacing:.08em;color:#cbd5e1">Sign in</span>
                    </div>
                    <h2 class="h3 fw-bold text-light mb-3 text-center">Viewer Portal</h2>
                    <p class="mb-4 text-secondary text-center">Access and discover amazing content.</p>
                    ...
                    <div class="mt-3 small small-link">No account? <a href="register.php">Create one</a></div>
                </div>
            </div>
        </div>
    </div>
